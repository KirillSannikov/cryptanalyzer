...
public class DecryptionFileWithTextDefault {
    ...
    public static void decodingDefault(){
        ...
        try{
            ...
            fileWriter.close();
            System.out.println(constDecryptionDefault.ready);
            System.out.println(constDecryptionDefault.decipheredText);
            System.out.println(constDecryptionDefault.fileLocation);
        } catch(Exception e){
            System.out.println(constDecryptionDefault.ciphertextGenerationError);
        }
    }
}
